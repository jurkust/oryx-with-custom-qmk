...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_SHIFT,  KC_A,           KC_S,           KC_D,           MT(MOD_LALT, KC_F),KC_G,                                           KC_H,           LT(4,KC_J),     KC_K,           KC_L,           KC_SCLN,        MT(MOD_RSFT, KC_QUOTE),
  ...
  [1] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_1,           KC_2,           KC_3,           KC_4,           KC_5,                                           KC_6,           KC_7,           KC_8,           KC_9,           KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_Q,           KC_W,           KC_E,           KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [3] = LAYOUT_voyager(
    RGB_TOG,        TOGGLE_LAYER_COLOR,RGB_MODE_FORWARD,RGB_SLD,        RGB_VAD,        RGB_VAI,                                        KC_BRIGHTNESS_DOWN,KC_BRIGHTNESS_UP,LCTL(LSFT(KC_TAB)),LCTL(KC_TAB),   KC_BSPC,        KC_DELETE,      
    KC_TRANSPARENT, KC_GRAVE,       KC_TRANSPARENT, KC_LBRC,        KC_RBRC,        KC_TAB,                                         KC_PAGE_UP,     KC_HOME,        KC_UP,          KC_END,         KC_PSCR,        KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LCBR,        KC_RCBR,        TD(DANCE_11),                                   KC_PGDN,        KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_TRANSPARENT, KC_GRAVE,       
  ...
  [5] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TAB,         KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [3] = { {189,255,255}, {189,255,255}, {189,255,255}, {189,255,255}, {189,255,255}, {189,255,255}, {189,255,255}, {189,255,255}, {189,255,255}, {139,255,255}, {139,255,255}, {189,255,255}, {189,255,255}, {189,255,255}, {189,255,255}, {139,255,255}, {139,255,255}, {189,255,255}, {23,225,192}, {23,225,192}, {23,225,192}, {23,225,192}, {23,225,192}, {189,255,255}, {189,255,255}, {189,255,255}, {189,255,255}, {189,255,255}, {189,255,255}, {189,255,255}, {0,218,204}, {0,218,204}, {189,255,255}, {189,255,255}, {0,0,255}, {189,255,255}, {189,255,255}, {189,255,255}, {189,255,255}, {0,0,255}, {0,0,255}, {0,0,255}, {189,255,255}, {189,255,255}, {189,255,255}, {189,255,255}, {169,255,255}, {189,255,255}, {189,255,255}, {0,218,204}, {189,255,255}, {189,255,255} },
...
tap_dance_action_t tap_dance_actions[] = {
        [DANCE_0] = ACTION_TAP_DANCE_TAP_HOLD(KC_1, KC_KP_1),
        [DANCE_1] = ACTION_TAP_DANCE_TAP_HOLD(KC_2, KC_KP_2),
        [DANCE_2] = ACTION_TAP_DANCE_TAP_HOLD(KC_3, KC_KP_3),
        [DANCE_3] = ACTION_TAP_DANCE_TAP_HOLD(KC_4, KC_KP_4),
        [DANCE_4] = ACTION_TAP_DANCE_TAP_HOLD(KC_5, KC_KP_5),
        [DANCE_5] = ACTION_TAP_DANCE_TAP_HOLD(KC_6, KC_KP_6),
        [DANCE_6] = ACTION_TAP_DANCE_TAP_HOLD(KC_7, KC_KP_7),
        [DANCE_7] = ACTION_TAP_DANCE_TAP_HOLD(KC_8, KC_KP_8),
        [DANCE_8] = ACTION_TAP_DANCE_TAP_HOLD(KC_EQUAL, RALT(KC_EQUAL)),
